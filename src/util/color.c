...
int n_colormaps = 11;
struct colormap * colormaps[11] =  {&s_cm_global_mono, &cm_rainbow, &cm_rainbow_edged, &cm_rainbow_equal, &cm_jet, &cm_hot, &cm_cyan, &cm_purple, &cm_stoplight, &cm_bright, &cm_goth};

...
SelfTimedReadBackOutputNode::SelfTimedReadBackOutputNode(Context *context, QSize chainSize, SelfTimedReadBackOutputNodePrivate *ptr, long msec)
    : OutputNode(ptr) {
    // TODO: refactor these two constructors

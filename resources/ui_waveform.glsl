...
void main(void) {
    ...
    gl_FragColor = compositeCR(gl_FragColor, vec4(0.5, 0.1, 0.1, a.a));
    gl_FragColor = compositeCR(gl_FragColor, vec4(0.0, 0.0, 0.6, a.b));
    gl_FragColor = compositeCR(gl_FragColor, vec4(0.3, 0.3, 1.0, a.g));
    gl_FragColor = compositeCR(gl_FragColor, vec4(0.7, 0.7, 1.0, a.r));

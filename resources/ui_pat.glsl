void main(void) {
    ...
    if(iSelection) {
        ...
        */
        ...
        f_color0 = composite(f_color0, vec4(0., 0., 0.3, smoothBox(gl_FragCoord.xy, slider_origin - vec2(w), slider_origin + slider_gain + vec2(w), w)));
        f_color0 = composite(f_color0, vec4(0., 0., 0.8, smoothBox(gl_FragCoord.xy, slider_pos - slider_size, slider_pos + slider_size, w)));
